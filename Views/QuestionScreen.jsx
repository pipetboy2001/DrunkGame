...
const QuestionScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    // Restablece el índice de la pregunta actual cuando se llega al final de la lista de preguntas
      ...
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.questionContainer, { transform: [{ rotateY: flipAnimation.interpolate({ inputRange: [0, 1], outputRange: ['0deg', '180deg'] }) }] }]}>
          ...
          <View style={styles.singleQuestionContainer}>
            {questions && questions.length > 0 && <Text style={styles.question}>{questions[currentQuestionIndex]}</Text>}
          </View>
